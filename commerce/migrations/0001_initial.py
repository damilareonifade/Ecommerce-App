    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_excerpt', models.CharField(blank=True, max_length=500, null=True, verbose_name='Product Short Description')),
                ...
                ('showed_price', models.DecimalField(blank=True, decimal_places=2, default=0.0, max_digits=10, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alt_text', models.TextField(blank=True, max_length=72, null=True)),
                ('product_image', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_image', to='commerce.product')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='product',
            name='saved_post',
            field=models.ManyToManyField(related_name='user_saved_post', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='product',
            name='seller',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='commerce.product')),
            ],
        ),
        migrations.CreateModel(
            name='Reviews',
            fields=[
                ...
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='product_reviews', to='commerce.product')),
